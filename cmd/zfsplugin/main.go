...
import (
	...
	"github.com/maxaudron/csi-driver-host-path/pkg/zfs"
)
...
var (
	...
	driverName        = flag.String("drivername", "zfs.csi.k8s.io", "name of the driver")
...
func handle() {
	driver, err := zfs.NewHostPathDriver(*driverName, *nodeID, *endpoint, *ephemeral, *maxVolumesPerNode, version)
	if err != nil {
