...
var zfsvolumesKind = schema.GroupVersionKind{Group: "zfs.csi.cocaine.farm", Version: "v1", Kind: "ZFSVolume"}
...
func (c *FakeZFSVolumes) Get(name string, options v1.GetOptions) (result *zfsvolumev1.ZFSVolume, err error) {
	...
	return obj.(*zfsvolumev1.ZFSVolume), err
}
...
func (c *FakeZFSVolumes) List(opts v1.ListOptions) (result *zfsvolumev1.ZFSVolumeList, err error) {
	...
	list := &zfsvolumev1.ZFSVolumeList{ListMeta: obj.(*zfsvolumev1.ZFSVolumeList).ListMeta}
	for _, item := range obj.(*zfsvolumev1.ZFSVolumeList).Items {
